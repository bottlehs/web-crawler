 ...
 */
   ...
   while (isLast) {
    ...
    if ( response.status == 200 ) {
      ...
      if ( data.result ) {
        ...
        const fileName = 'parse/pedia_watcha/pedia_watcha_movies_page_'+page+'.json';
 ...
 module.exports = { getItems };
  ...
  async function handleAsync() {
    ...
    console.log('영화 총합 : '+pediaWatchaRes.length);

    const fileName = 'parse/pedia_watcha/pedia_watcha_movies.json';
